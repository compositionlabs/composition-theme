    ...
    <div className="flex flex-col justify-center w-full font-mono text-sm leading-8 text-black dark:text-white max-w-6xl m-auto px-4 md:px-0">
      <main>
        <section id="how-do-i-use-it" className="mt-4 mb-12">
          ...
          <p className="text-sm leading-relaxed my-3">Finetune our pre-trained model on at least 30 simulations. If your simulations are CFD, now you can run CFD simulations on novel geometries in seconds. The same logic applies for any simulation type.</p>
